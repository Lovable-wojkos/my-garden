...
|---|---|---|---|---|---|
| 1 | F-01 | [F-01] Design and migrate: fields, plants, plantings, weather_records tables with RLS | `foundation` `DataFoundation` `PlantCatalog` | open | https://github.com/Lovable-wojkos/my-garden/issues/1 |
...
| 3 | F-02 | [F-02] Scaffold Vercel Cron nightly IMGW fetch -> weather_records | `foundation` `DataFoundation` `Weather` | open | https://github.com/Lovable-wojkos/my-garden/issues/3 |
